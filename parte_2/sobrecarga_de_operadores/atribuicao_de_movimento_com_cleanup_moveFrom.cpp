...
namespace Classes
{
    inline namespace SobrecargaDeOperadores
    {
        ...
        void UmaClasse::cleanup() noexcept
        {
          delete membroAlocado;

          membroAlocado = nullptr;
        }

        void UmaClasse::moveFrom(UmaClasse& objetoFonte) noexcept
        {
          membroAlocado = objetoFonte.membroAlocado;

          objetoFonte.membroAlocado = nullptr;
        }
