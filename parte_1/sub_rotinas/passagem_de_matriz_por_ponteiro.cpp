...
void imprimeMatriz1(int matriz[2][2]); //Ou: void imprimeMatriz1(int matriz[][2]); Ou void imprimeMatriz1(int (*matriz)[2])
void imprimeMatriz2(int** matriz);
...
void imprimeMatriz1(int matriz[2][2]) //Ou: void imprimeMatriz1(int matriz[][2])
{
  int i, j;
  for (i = 0; i < 2; ++i)
  {
